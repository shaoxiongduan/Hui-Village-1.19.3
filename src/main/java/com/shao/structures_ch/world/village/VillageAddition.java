package com.shao.structures_ch.world.village;

import com.shao.structures_ch.Structures_ch;
...
@Mod.EventBusSubscriber(modid = Structures_ch.MOD_ID)
public class VillageAddition {
    ...
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ...
                "structures_ch:bathroom", 350);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:hotel", 200);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_small_house_1", 25);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_butcher_shop_1", 150);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_library_1", 700);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_stable_1", 150);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_weaponsmith", 50);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_butcher_2", 150);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:plains_farm", 25);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:fisher_cottage", 200);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/plains/houses"),
                "structures_ch:temple", 600);
        //addBuildingToPool(templatePoolRegistry, processorListRegistry,
